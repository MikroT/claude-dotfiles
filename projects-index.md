...
A running index of projects worked on with Claude Code — not a replacement for GitHub's own list, but the context GitHub doesn't show: purpose, current state, where it actually runs, and links to its own decision/runbook docs.
...
Un indice vivo dei progetti su cui lavoro con Claude Code — non sostituisce la lista GitHub, ma aggiunge il contesto che GitHub non mostra: scopo, stato attuale, dove gira davvero, e link alla sua documentazione decisioni/runbook.
